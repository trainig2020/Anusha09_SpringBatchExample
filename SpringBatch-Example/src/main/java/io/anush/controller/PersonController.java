...
import io.anush.config.BatchConfig;
...
public class PersonController {
	...
	public BatchStatus load() throws JobParametersInvalidException, JobExecutionAlreadyRunningException,
		...
		Directory folder = new Directory("C:\\csvfiles");
		Directory folderCopy = new Directory("C:\\copyfiles");
		try {
	...
	public ModelAndView manualSchedule() {
		File files = new File("C:\\csvfiles");
	...
	public ModelAndView manualmodeSch(HttpServletRequest request, HttpServletResponse response) {
		...
		int i = 0;
		try {
			Resource[] resources = resolver.getResources("file:c:/csvfiles/person*.csv");
